...
class SolutionTest {
  ...
  static Stream<Arguments> solutionReturnsExpectedResult() {
    return Stream.of(
        Arguments.of(
            20,
            new int[] {1, 17, 1, 21, 2, 25, 17, 10, 23, 28, 9, 46, 18, 32, 34, 31, 49, 24, 23, 9},
            new int[] {29, 9, 14, 8, 12, 40, 6, 50, 45, 33, 22, 21, 2, 47, 16, 28, 18, 48, 15, 22},
            new int[][] {
            ...
            11,
            82),
        Arguments.of(2, new int[] {33, 13}, new int[] {34, 15}, new int[][] {{1, 2}}, 20, 2));
  }
}
